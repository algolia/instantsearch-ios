...
extension MultiIndexHitsInteractorControllerConnectionTests {
  class ConnectionTester {
    ...
    private func checkScrollToTop(isConnected: Bool, file _: StaticString = #file, line _: UInt = #line) {
    ...
    private func checkReload(isConnected: Bool, file _: StaticString = #file, line _: UInt = #line) {
