...
public protocol SelectableListPresentable {
  func transform(refinementFacets: [SelectableItem<FacetHits>]) -> [SelectableItem<FacetHits>]
}
...
public class FacetListPresenter: SelectableListPresentable {
  ...
  public func transform(refinementFacets: [SelectableItem<FacetHits>]) -> [SelectableItem<FacetHits>] {
  ...
  private func sorter(using sortCriterions: [FacetSortCriterion]) -> (SelectableItem<FacetHits>, SelectableItem<FacetHits>) -> (Bool) {
    return { lhs, rhs in
