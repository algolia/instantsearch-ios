...
@objc open class RefinementCollectionViewController: UIViewController,
    ...
    public func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        guard let collectionView = collectionView as? RefinementCollectionWidget,
          let index = self.refinementCollectionViews.firstIndex(of: collectionView) else { return 0 }
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let collectionView = collectionView as? RefinementCollectionWidget,
          let index = self.refinementCollectionViews.firstIndex(of: collectionView) else { return UICollectionViewCell() }
    ...
    public func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        guard let collectionView = collectionView as? RefinementCollectionWidget,
          let index = self.refinementCollectionViews.firstIndex(of: collectionView) else { return }
